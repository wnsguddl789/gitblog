...
export declare abstract class BaseCommand extends Command {
    ...
    clearCacheIfNeeded: () => T.Effect<OT.HasTracer & import("@effect-ts/system/Has").Has<import("@contentlayer/utils/effect/ConsoleService").ConsoleService>, fs.RmError, void>;
}
