 ...
 * @param field
 */
export const normalizeSitemapField = (config, field) => {
    var _a;
    // Handle trailing Slash
    const trailingSlash = 'trailingSlash' in field ? field.trailingSlash : config.trailingSlash;
    return Object.assign(Object.assign({}, field), { trailingSlash, loc: absoluteUrl(config.siteUrl, field === null || field === void 0 ? void 0 : field.loc, trailingSlash), alternateRefs: ((_a = field.alternateRefs) !== null && _a !== void 0 ? _a : []).map((alternateRef) => ({
...
export const createUrlSet = (config, manifest) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (config.additionalPaths) {
        const additions = (_g = (yield config.additionalPaths(Object.assign(Object.assign({}, config), { transform: (_f = config.transform) !== null && _f !== void 0 ? _f : transformSitemap })))) !== null && _g !== void 0 ? _g : [];
