...
exports.createUrlSet = exports.normalizeSitemapField = exports.absoluteUrl = exports.entityEscapedUrl = void 0;
 ...
 * @param field
 */
const normalizeSitemapField = (config, field) => {
    var _a;
    // Handle trailing Slash
    const trailingSlash = 'trailingSlash' in field ? field.trailingSlash : config.trailingSlash;
    return Object.assign(Object.assign({}, field), { trailingSlash, loc: (0, exports.absoluteUrl)(config.siteUrl, field === null || field === void 0 ? void 0 : field.loc, trailingSlash), alternateRefs: ((_a = field.alternateRefs) !== null && _a !== void 0 ? _a : []).map((alternateRef) => ({
            href: alternateRef.hrefIsAbsolute
                ? alternateRef.href
                : (0, exports.absoluteUrl)(alternateRef.href, field.loc, trailingSlash),
            hreflang: alternateRef.hreflang,
        })) });
};
exports.normalizeSitemapField = normalizeSitemapField;
/**
...
const createUrlSet = (config, manifest) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allKeys = [
        ...
        ...((_c = (_b = manifest === null || manifest === void 0 ? void 0 : manifest.build) === null || _b === void 0 ? void 0 : _b.ampFirstPages) !== null && _c !== void 0 ? _c : []),
    ...
    const notFoundRoutes = ((_e = (_d = manifest.preRender) === null || _d === void 0 ? void 0 : _d.notFoundRoutes) !== null && _e !== void 0 ? _e : []);
    ...
    if (config.additionalPaths) {
        const additions = (_g = (yield config.additionalPaths(Object.assign(Object.assign({}, config), { transform: (_f = config.transform) !== null && _f !== void 0 ? _f : config_1.transformSitemap })))) !== null && _g !== void 0 ? _g : [];
    ...
    return sitemapFields.map((x) => (0, exports.normalizeSitemapField)(config, x));
});
