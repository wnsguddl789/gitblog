...
import { sampleManifest, sampleI18nManifest, sampleNotFoundRoutesManifest, } from '../../../fixtures/manifest';
describe('createUrlSet', () => {
    ...
    test('with i18n exclusion', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield createUrlSet(Object.assign(Object.assign({}, sampleConfig), { exclude: ['/', '/page-0', '/page-2', '/about', '/fr*'] }), sampleI18nManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('with alternateRefs', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield createUrlSet(Object.assign(Object.assign({}, sampleConfig), { siteUrl: 'https://example.com/', alternateRefs: [
    ...
    test('with absolute alternateRefs', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield createUrlSet(Object.assign(Object.assign({}, sampleConfig), { siteUrl: 'https://example.com/', alternateRefs: [
    ...
    test('with additionalPaths', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const config = Object.assign(Object.assign({}, sampleConfig), { siteUrl: 'https://example.com/', transform: mockTransform, additionalPaths: (config) => __awaiter(void 0, void 0, void 0, function* () {
                return [
        ...
        const urlset = yield createUrlSet(config, sampleManifest);
    ...
    test('with next i18n enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield createUrlSet(sampleConfig, sampleI18nManifest);
        expect(urlset).toStrictEqual([
    ...
    test('with i18n, without notFound routes', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield createUrlSet(Object.assign({}, sampleConfig), sampleNotFoundRoutesManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
