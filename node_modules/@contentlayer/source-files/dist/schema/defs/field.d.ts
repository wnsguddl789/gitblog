...
export declare type FieldDef = ListFieldDef | ListPolymorphicFieldDef | StringFieldDef | NumberFieldDef | BooleanFieldDef | JSONFieldDef | DateFieldDef | MarkdownFieldDef | MDXFieldDef | EnumFieldDef | NestedFieldDef | NestedPolymorphicFieldDef | ReferenceFieldDef | ReferencePolymorphicFieldDef;
/**
...
export declare namespace ListFieldDefItem {
    type Item = ItemString | ItemEnum | ItemBoolean | ItemNestedType | ItemDocumentReference;
    type ItemString = {
        type: 'string';
    };
    type ItemEnum = {
