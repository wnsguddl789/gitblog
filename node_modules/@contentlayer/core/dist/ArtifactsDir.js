...
(function (ArtifactsDir) {
    ...
    ArtifactsDir.getCacheDirPath = (T.map_(T.struct({
        ...
        cwd: getCwd,
    }, fileName_1 + ":26:13"), ({ contentlayerVersion, cwd }) => filePathJoin(ArtifactsDir.getDirPath({ cwd }), '.cache', `v${contentlayerVersion}`), fileName_1 + ":30:10"));
    ArtifactsDir.mkdirCache = (T.tap_(ArtifactsDir.getCacheDirPath, fs.mkdirp, fileName_1 + ":36:32"));
