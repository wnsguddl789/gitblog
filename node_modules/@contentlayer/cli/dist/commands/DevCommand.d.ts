...
export declare class DevCommand extends BaseCommand {
    static paths: string[][];
    static usage: Usage;
    executeSafe: () => T.Effect<import("@effect-ts/otel").HasTracer & import("@effect-ts/system/Has").Has<import("@contentlayer/utils/effect/ConsoleService.js").ConsoleService> & core.HasCwd & import("@effect-ts/system/Has").Has<core.Cwd> & import("@effect-ts/system/Has").Has<import("@effect-ts/otel").Tracer> & import("@contentlayer/utils/effect").HasClock & import("@contentlayer/utils/effect").HasConsole, import("@contentlayer/utils/node/fs.js").RmError, void>;
}
