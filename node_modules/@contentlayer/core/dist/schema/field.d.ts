...
export declare type FieldDef = ListFieldDef | ListPolymorphicFieldDef | StringFieldDef | NumberFieldDef | BooleanFieldDef | JSONFieldDef | DateFieldDef | MarkdownFieldDef | MDXFieldDef | EnumFieldDef | NestedFieldDef | NestedPolymorphicFieldDef | NestedUnnamedFieldDef | ReferenceFieldDef | ReferencePolymorphicFieldDef;
...
export declare type SlugFieldDef = FieldDefBase & {
    type: 'slug';
    default: string | undefined;
};
...
export declare type TextFieldDef = FieldDefBase & {
    type: 'text';
    default: string | undefined;
};
...
export declare type UrlFieldDef = FieldDefBase & {
    type: 'url';
    default: string | undefined;
};
...
export declare type NestedUnnamedFieldDef = FieldDefBase & {
    type: 'nested_unnamed';
    default: any | undefined;
    typeDef: NestedUnnamedTypeDef;
};
