...
declare const FileWatcherError_base: import("@effect-ts/system/Case").CaseConstructorTagged<"FileWatcherError", "_tag">;
...
export declare const makeAndSubscribe: (paths: readonly string[] | string, options?: Chokidar.WatchOptions | undefined) => S.Stream<unknown, never, E.Either<FileWatcherError, FileSystemEvent>>;
