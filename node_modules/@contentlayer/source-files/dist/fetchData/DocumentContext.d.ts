...
export declare const makeAndProvideDocumentContext: ({ rawContent, relativeFilePath, }: Omit<DocumentContext, 'rawDocumentData'>) => <R1, E1, A1>(ma: T.Effect<R1 & Has<DocumentContext>, E1, A1>) => T.Effect<R1, E1, A1>;
