...
export declare const log: (...args: any[]) => T.Effect<import("@effect-ts/system/Has").Has<ConsoleService>, never, void>;
export declare const rightOrFail: <R, E1, EE1, A>(effect: T.Effect<R, E1, E.Either<EE1, A>>, __trace?: string | undefined) => T.Effect<R, E1 | EE1, A>;
export declare const eitherMap: <A1, A2>(mapRight: (a1: A1) => A2) => <R, E1, EE1>(effect: T.Effect<R, E1, E.Either<EE1, A1>>, __trace?: string | undefined) => T.Effect<R, E1, E.Either<EE1, A2>>;
