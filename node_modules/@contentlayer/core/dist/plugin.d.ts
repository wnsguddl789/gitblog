 ...
 * ```
 */
export declare type MarkdownUnifiedBuilderCallback = (builder: unified.Processor) => void;
...
export declare type MDXBundlerMDXOptions = mdxBundler.BundleMDXOptions<any>['mdxOptions'];
...
export declare type ProvideSchema = (esbuildHash: string) => T.Effect<OT.HasTracer & HasConsole, SourceProvideSchemaError, SchemaDef>;
...
export declare const processArgs: <TArgs extends PartialArgs>(argsOrArgsThunk: TArgs | Thunk<TArgs> | Thunk<Promise<TArgs>>) => Promise<{
    extensions: PluginExtensions;
    options: PluginOptions;
    restArgs: Omit<TArgs, "date" | "markdown" | "mdx" | "extensions" | "fieldOptions" | "disableImportAliasWarning">;
}>;
